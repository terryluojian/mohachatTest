...
ALTER TABLE ONLY "#pref_chat_moha"
    ADD CONSTRAINT "#pref_chat_moha_ID_key" UNIQUE ("ID", "time");


CREATE TABLE "#pref_chat_moha_archive" (
  "ID" int NOT NULL,
...
CREATE TABLE "#pref_chat_moha_buddy" (
...
ALTER TABLE ONLY "#pref_chat_moha_buddy"
    ADD CONSTRAINT "#pref_chat_moha_buddy_UID_key" PRIMARY KEY ("UID", "BID");


CREATE TABLE "#pref_chat_moha_file_hist" (
  "id" int NOT NULL,
...
CREATE TABLE "#pref_chat_moha_file_up" (
  "id" serial NOT NULL PRIMARY KEY,
...
CREATE TABLE "#pref_chat_moha_poll" (
